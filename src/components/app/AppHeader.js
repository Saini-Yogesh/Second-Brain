...
export class AppHeader extends LitElement {
    ...
    async _checkForUpdates() {
        try {
            ...
            const response = await fetch('https://raw.githubusercontent.com/Saini-Yogesh/Second-Brain/refs/heads/main/package.json');
    ...
    async _openUpdatePage() {
        ...
        await ipcRenderer.invoke('open-external', 'https://github.com/Saini-Yogesh/Second-Brain');
    }
