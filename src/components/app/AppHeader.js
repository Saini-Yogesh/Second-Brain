...
export class AppHeader extends LitElement {
    ...
    async _checkForUpdates() {
        try {
            ...
            const response = await fetch('https://raw.githubusercontent.com/yogesh-saini/Self-Helping-Tool/refs/heads/master/package.json');
    ...
    async _openUpdatePage() {
        ...
        await ipcRenderer.invoke('open-external', 'https://github.com/yogesh-saini/Self-Helping-Tool/releases');
    }
    ...
    getViewTitle() {
        const titles = {
            onboarding: 'Welcome to Second Brain',
            main: 'Second Brain',
            customize: 'Customize',
            help: 'Help & Shortcuts',
            history: 'Conversation History',
            advanced: 'Advanced Tools',
            assistant: 'Second Brain',
        };
        return titles[this.currentView] || 'Second Brain';
    }
