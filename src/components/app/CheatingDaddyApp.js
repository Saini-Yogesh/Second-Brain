...
export class CheatingDaddyApp extends LitElement {
    ...
    async _checkForUpdates() {
        try {
            ...
            const res = await fetch('https://raw.githubusercontent.com/yogesh-saini/Self-Helping-Tool/refs/heads/master/package.json');
            if (!res.ok) return;
                ...
                <div class="sidebar-footer">
                    ${
                        this._updateAvailable
                            ? html`
                                  <button class="update-btn" @click=${() => this.handleExternalLinkClick('https://github.com/yogesh-saini/Self-Helping-Tool/releases')}>
